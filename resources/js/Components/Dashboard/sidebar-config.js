...
export const adminSidebarItems = [
  ...
  { key: "appointments", label: "Appointments", icon: "appointments" },
  {
    ...
    children: [
      ...
      { key: "payments-successful", label: "Successful Payments" },
      { key: "payments-pending", label: "Pending Payments" },
      { key: "payments-failed", label: "Failed Payments" },
      {
        key: "payments-refunds",
        label: "Refunds",
        children: [
          { key: "refunds-all", label: "All Refunds" },
          { key: "refunds-pending", label: "Pending Requests" },
          { key: "refunds-approved", label: "Approved" },
          { key: "refunds-rejected", label: "Rejected" },
          { key: "refunds-completed", label: "Completed" },
        ],
      },
      { key: "payments-transactions", label: "Transactions" },
      { key: "payments-revenue", label: "Revenue" },
