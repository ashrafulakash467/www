      ...
      <div className="flex flex-col gap-4 border-b border-slate-200 pb-5 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex w-full flex-col gap-2 sm:w-auto sm:flex-row sm:items-center">
          <label className="relative flex items-center">
            <span className="sr-only">Select appointment</span>
            <select
              value={selectedAppointmentId || ""}
              onChange={(event) => {
                if (event.target.value) openDetails(event.target.value);
              }}
              className="w-full appearance-none rounded-lg border border-slate-200 bg-white py-2 pl-3 pr-9 text-sm font-semibold text-slate-700 outline-none transition focus:border-slate-400 sm:w-56"
            >
          ...
          <label className="relative flex items-center">
            ...
            <input
              ...
              className="w-full rounded-lg border border-slate-200 bg-white py-2 pl-9 pr-3 text-sm font-semibold text-slate-700 outline-none transition focus:border-slate-400 sm:w-44"
            />
          </label>
          ...
          <div className="mt-4 grid gap-3">
            {visibleAppointments.length === 0 ? (
              <p className="rounded-2xl border border-dashed border-slate-200 bg-slate-50 px-4 py-6 text-center text-sm text-slate-500">
                {filterDate ? "No appointments found for this date." : "No appointments available."}
              </p>
            ) : (
        ...
        {isDetailsOpen && selectedAppointment ? (
          ...
          >
            <section
              ...
              role="dialog"
              aria-modal="true"
              aria-labelledby="upload-document-details-title"
            >
          {selectedAppointment ? (
            <form className="space-y-5" onSubmit={handleSubmit}>
              <div className="flex items-start justify-between gap-4 border-b border-slate-100 pb-4">
                <div>
                  ...
                  <h2
                    id="upload-document-details-title"
                ...
                <button
                  ...
                  aria-label="Close upload document details"
                >
                  X
                </button>
              </div>
